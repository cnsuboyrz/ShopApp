        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IConfiguration configuration, UserManager<User> userManager, RoleManager<IdentityRole> roleManager, ICartService cartService)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapControllerRoute(
                  ...
                  pattern: "admin/maincategories",
                  defaults: new { controller = "Admin", action = "MainCategoryList" }
              );

                endpoints.MapControllerRoute(
                    name: "adminmaincategorycreate",
                    pattern: "admin/maincategories/create",
                    defaults: new { controller = "Admin", action = "MainCategoryCreate" }
                );

                endpoints.MapControllerRoute(
                    name: "adminmaincategoryedit",
                    pattern: "admin/maincategories/{id?}",
                    defaults: new { controller = "Admin", action = "MainCategoryEdit" }
                );
                endpoints.MapControllerRoute(
                   name: "admingetallorders",
                   pattern: "admin/getallorders",
